...
ten_k_random_wp_pages <- readRDS(here::here("analysis/data/raw_data/random_page_data_tbl.rds"))

# load the random pages revision histories
ten_k_random_wp_pages_lst <- readRDS(here::here("analysis/data/raw_data/random_page_data_lst.rds"))
...
wh_wiki_talk_pages <-  readRDS(here::here("analysis/data/raw_data/wh_wiki_table_talk_page_content.rds"))

# all WH sites according to UNESCO
# from https://whc.unesco.org/en/syndication
wh_unesco <- wh_wiki_table %>%
...
wh_wiki_table_location <-
  wh_wiki_table %>%
  mutate(country = str_extract(states_name_en, # Location,
                                 regex(country_names,
                                       ignore.case=TRUE))) %>%
    mutate(country = case_when(
      country == "United States" ~ "United States of America",
